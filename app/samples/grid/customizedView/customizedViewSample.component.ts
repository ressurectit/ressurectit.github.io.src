...
@Component(
{
    selector: 'customized-view-sample',
    templateUrl: 'customizedViewSample.component.html',
    imports:
    [
        MatrixGridModule,
    ],
...
export class CustomizedViewSampleComponent
{
    ...
    /**
     * Grid options that are used for grid initialization for gallery sample
     */
