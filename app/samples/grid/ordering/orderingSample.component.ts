...
import {AsyncDataLoaderOptions, DataResponse, GridOptions, MatrixGridModule, SimpleOrdering, OrderableDirective} from '@anglr/grid';
...
@Component(
{
    selector: 'ordering-sample',
    templateUrl: 'orderingSample.component.html',
    imports:
    [
        MatrixGridModule,
        OrderableDirective,
...
export class OrderingSampleComponent
{
